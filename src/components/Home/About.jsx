...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: `I was highly recommended S A Motors on many Facebook groups and forums after having a Nox sensor fault in my Caddy Maxi Life and reaching out for advice.
I am so grateful as the whole experience has been brilliant.`,
    name: "Rose Humble",
  },
